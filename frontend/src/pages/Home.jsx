    ...
    <div className="bg-slate-950 text-white overflow-x-hidden relative font-sans">
      ...
      <header
        className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${
          scrollY > 50
            ? "bg-slate-950/90 border-b border-white/10 backdrop-blur-xl shadow-lg"
            : "bg-transparent pt-4"
        }`}
      >
        <div className="max-w-7xl mx-auto px-6 py-3 flex justify-between items-center">
          ...
          <div className="flex items-center gap-3 cursor-pointer" onClick={navigateHome}>
            <img
              src="/logo.png"
              alt="SportNova Logo"
              className="h-12 w-auto hover:scale-105 transition-transform drop-shadow-[0_0_15px_rgba(59,130,246,0.5)]"
            />
          </div>
            ...
            {user ? (
              <>
                <a
                  ...
                  className="bg-blue-600 hover:bg-blue-700 px-6 py-2 rounded-sm skew-x-[-10deg] flex items-center gap-2"
                >
                  <span className="skew-x-[10deg] flex gap-2">
                ...
                <button
                  onClick={logoutUser}
                  className="border border-red-500/50 text-red-400 px-6 py-2 rounded-sm skew-x-[-10deg] hover:bg-red-500 hover:text-white"
                >
                  <span className="skew-x-[10deg] flex gap-2">
              ...
              <div className="flex items-center gap-4">
                <a href="/login" className="text-white hover:text-blue-400 font-bold italic">
                  Login
                </a>

                <a
                  href="/register"
                  className="bg-gradient-to-r from-orange-500 to-red-600 px-6 py-2 rounded-sm skew-x-[-10deg] hover:scale-105 transition-transform"
                >
      ...
      -------------------------------------------------- */}
      <div
        className={`fixed top-[80px] left-0 right-0 z-40 md:hidden bg-slate-900/95 backdrop-blur-xl border-b border-white/10 transition-all duration-300 ${
      ...
      >
        <div className="p-6 space-y-4 font-bold uppercase italic">
          <Link
            to="/about"
            className="block text-slate-300 hover:text-white py-3 border-b border-white/5"
          ...
          <div className="pt-4 space-y-3 not-italic">
            {user ? (
              <button
                ...
                className="w-full bg-red-600 py-3 rounded-sm"
              >
                Logout
              </button>
            ) : (
              <>
                <a href="/login" className="block text-center py-3 text-slate-300">
                  Login
                </a>
                <a
                  href="/register"
                  className="block bg-blue-600 text-white py-3 rounded-sm text-center"
                >
                  Join Now
                </a>
              </>
...
/* --------------------------------------------------
   SUB-COMPONENTS (UNCHANGED, UI ONLY)
-------------------------------------------------- */
    ...
    <section className="relative z-10 pt-48 pb-32 px-6 overflow-hidden text-center">
      <div className="max-w-7xl mx-auto">
        ...
        <motion.div 
          ...
          className="inline-flex items-center gap-2 bg-blue-600/10 border border-blue-500/30 px-5 py-2 rounded-full mb-8 backdrop-blur-sm"
        >
          <Sparkles className="w-4 h-4 text-blue-400 animate-pulse" />
          <span className="text-sm text-blue-300 font-bold uppercase tracking-widest">
            Talent Unleashed
          </span>
        </motion.div>
        ...
        <motion.h1 
          ...
          className="text-7xl md:text-8xl font-black italic uppercase leading-[0.9] mb-8"
        >
          DOMINATE <br />
          <span className="bg-gradient-to-r from-blue-500 via-cyan-400 to-white text-transparent bg-clip-text animate-gradient">
            THE GAME
          </span>
        </motion.h1>
        ...
        <motion.p 
          ...
          className="max-w-2xl mx-auto text-slate-400 text-xl font-medium leading-relaxed"
        >
        ...
        >
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="group bg-gradient-to-r from-blue-600 to-blue-500 px-8 py-4 rounded-lg shadow-[0_0_30px_rgba(59,130,246,0.3)] hover:shadow-[0_0_50px_rgba(59,130,246,0.5)] transition-all"
          >
            <span className="flex items-center justify-center gap-3 font-black uppercase tracking-wide">
              Start Career <ChevronRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </span>
          </motion.a>
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="group border border-white/20 px-8 py-4 rounded-lg backdrop-blur-sm hover:bg-white/5 transition-all"
          >
            <span className="flex items-center justify-center gap-3 font-bold uppercase tracking-wide">
        ...
        <motion.div 
          ...
          className="mt-24 bg-slate-900/30 backdrop-blur-xl border-y border-white/5 py-10 rounded-lg"
        >
  ...
  return (
    <section id="about" className="py-24 px-6 bg-gradient-to-b from-slate-900/30 to-transparent border-y border-white/5">
      <div className="max-w-6xl mx-auto">
        ...
        >
          <h2 className="text-5xl font-black italic uppercase mb-4">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <FeatureCard 
            ...
            desc="Deep performance stats with trend analysis and predictive modeling." 
            color="orange" 
            delay={0.2}
          />
          <FeatureCard 
            ...
            desc="Head-to-head metrics comparison with benchmarking against top performers." 
            color="green" 
            delay={0.3}
          />
          <FeatureCard 
            ...
            desc="Comprehensive team management with player tracking and assessment tools." 
            color="red" 
            delay={0.4}
          />
          <FeatureCard 
            icon={<Eye />} 
            title="Scout Network" 
            desc="Direct access to talent scouts and recruiters actively seeking athletes." 
            color="purple" 
            delay={0.5}
          />
          <FeatureCard 
            ...
            desc="Instant notifications for scout views, messages, and recruitment opportunities." 
            color="cyan" 
            delay={0.6}
          />
        </div>
    ...
    <section id="contact" className="py-24 px-6 bg-gradient-to-b from-transparent to-slate-900/30">
      <div className="max-w-5xl mx-auto">
        ...
        <motion.div 
          ...
          className="mt-12 text-center bg-slate-900/50 backdrop-blur-sm border border-white/5 rounded-lg p-8"
        >
  ...
  return (
    <footer className="py-12 px-6 border-t border-slate-800 bg-slate-950">
      <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-8">
        ...
        <div className="flex items-center gap-4">
          <img src="/logo.png" alt="SportNova" className="h-10 opacity-80" />
          <span className="text-slate-500 text-sm">© {new Date().getFullYear()} SportNova Inc.</span>
        </div>

        <div className="flex gap-8 text-slate-400 text-sm font-bold uppercase tracking-wider">
          <button onClick={() => openModal("privacy")} className="hover:text-blue-400">Privacy</button>
          <button onClick={() => openModal("terms")} className="hover:text-blue-400">Terms</button>
          <button onClick={() => openModal("support")} className="hover:text-blue-400">Support</button>
        </div>
      </div>
    </footer>
  );
...
function StatCard({ number, label, icon, delay = 0 }) {
  return (
    ...
    >
      ...
      <div className="text-4xl font-black italic mt-2 transition-all">
        {number}
      </div>
